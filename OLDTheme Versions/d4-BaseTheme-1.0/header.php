	<!DOCTYPE html><html <?php language_attributes(); ?> id="<?php echo css_browser_selector() ?>">
<head>
...
<!-- Javascript / jQuery -->
<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/inc/jquery-1.8.1.min.js"></script>
