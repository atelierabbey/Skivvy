...
if( current_user_can( 'manage_plugins' )) {add_filter( 'in_admin_header', 'wp_codex_search_form', 11 );}// The number 11 needs to be a 10 for this to work! 
...
/* -------------------------------
		 Debug logging
---------------------------------*/ 
//Pass the '?debug=#' parameter at the end of any url on site // http://example.com/?debug=1, /?debug=2, /?debug=3   --- More Info http://comluv.com/dev/enable-debugging-and-logging-for-live-site-usage/
