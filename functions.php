<?php // 8Aug13 - Functions.php is like Batman's Tool belt. It has a ton of freakishly-specific gadgets and plenty of bat-a-rangs.
// Core & Setup
...
# include_once 'inc/module_browserdetect.php';
# include_once 'inc/module_randimg.php'; 
# include_once 'inc/module_advstyles.php'; 
# include_once 'inc/module_posttypetools.php';
# include_once 'inc/module_rewrites.php';
