...
function portfoliosc($atts){
	...
	if ($the_query->have_posts()){
		...
		while ( $the_query->have_posts() ) : $the_query->the_post();
			$content .= '<div class="pstthmb"><a href="'.wp_get_attachment_url(get_post_thumbnail_id($post->ID)).'" rel="shadowbox[portfolio-'.$cat.']">'.get_the_post_thumbnail($post->ID,"thumbnail").'</a></div>';
		endwhile;
    } else { 
        $content = null;
    }
