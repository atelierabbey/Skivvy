<?php function shadowbox_init(){
 echo '<script type="text/javascript" src="' . get_bloginfo("template_url") . '/inc/shadowbox/shadowbox.js"></script>';
 echo '<script type="text/javascript" src="' . get_bloginfo("template_url") . '/inc/shadowbox/shadowbox.css"></script>';
